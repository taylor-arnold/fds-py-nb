...
15. Now, create a dataset `df_precision` that has the precision of each class. Remember, this is, for each class, the proportion of items that were predicted to be that class that were correct. You should notice that this is very similar to the code from the previous question.
